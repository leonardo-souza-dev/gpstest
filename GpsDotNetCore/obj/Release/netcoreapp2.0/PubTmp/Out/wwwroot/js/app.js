...
app.controller('MapController', function ($scope, $cordovaGeolocation, $ionicLoading, $ionicPlatform) {
    ...
    $scope.mostrarAtualizarLocalizacao = true;

    $scope.distanciaMinima = 100;
    ...
    $scope.naoFazerCheckin = function(){
        $scope.decidiuNaoFazerCheckin = true;
    }

    $scope.decidiuNaoFazerCheckin = false;

    $scope.atualizarLocalizacao = function (posOptions) {

        $scope.mostrarAtualizarLocalizacao = true;
        $scope.decidiuNaoFazerCheckin = null;
        ...
        $cordovaGeolocation.getCurrentPosition(posOptions).then(function (position) {
            ...
            $scope.localPerto = $scope.locaisPerto[0];
